...
.. tabs::
   ...
   .. tab:: Training procedure

      Add content for training procedure scope here.
   
   .. tab:: Validation procedure

      Add content for verification procedure scope here.

   .. tab:: Coding guidelines

      Add content for coding guidelines scope here.
