...
.. tab-set::
   ...
   .. tab-item:: Bioinformatics procedure
      ...
      .. admonition:: Example – HIV Antiviral Resistance Pipeline
         ...
         This example outlines the scope for a bioinformatics SOP focused on HIV antiviral resistance analysis.
   ...
   .. tab-item:: Training procedure
      ...
      .. admonition:: Example – Training SOP
         :class: note

         This example outlines the scope for a training procedure SOP within a genomics service.
   ...
   .. tab-item:: Code update & review
      ...
      .. admonition:: Example – Code Review SOP
         :class: note

         This example outlines the scope for a procedure governing code updates and review.
