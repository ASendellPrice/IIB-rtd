...
Examples of scope content for different types of procedures are provided below.

.. tab-set::

   .. tab-item:: 🧬 Bioinformatics

      .. admonition:: Example scope content for a bioinformatics SOP on HIV antiviral resistance analysis
         :class: hint
   ...
   .. tab-item:: 🔬 Lab procedure
      ...
      .. admonition:: Example scope content for a lab procedure SOP for nucleic acid extraction
         :class: hint
